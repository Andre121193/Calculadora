...
const App = () => {
  ...
  const handleMinusNumber = () => {
    ...
    if(firstNumber === '0'){
      ...
      const subreaction = Number(firstNumber) - Number(currentNumber);
      setCurrentNumber(String(subreaction));
      setOperation('');
    }
  }
  ...
  const handleMultiplicationNumber = () => {
    ...
    if(firstNumber === '0'){
      ...
      const multiplicatio = Number(firstNumber) * Number(currentNumber);
      setCurrentNumber(String(multiplicatio));
      setOperation('');
    }
  }
